...
Feature: Utest page
  ...
  Scenario: sign up for Utest
    ...
    | Gabriel      | Guerrero     | rrerom@correo.udistrital.edu.co    | January  | 31     | 1997    | Spanish     | Bogota  | 1212121   | Colombia   | Windows     | 10         | Spanish       | Xiaomi    | Redmi 7  | Android 10| Universidad123*|
